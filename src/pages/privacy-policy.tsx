  ...
  return (
    <PublicLayout title="">
        ...
        <section className="main-container top-spacing bottom-spacing prose prose-sm">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Home Quest, 1.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Home Quest, accessible from{" "}
                <a
                  href="https://home-quest-web.vercel.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://home-quest-web.vercel.app/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: info@homequest.com</p>
            </li>
            <li>
              <p>
