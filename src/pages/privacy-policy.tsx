...
const PrivacyPolicy = () => {
  return (
    <section className="main-container top-spacing bottom-spacing prose prose-sm">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Wiki Weather, sw.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Wiki Weather, accessible from{" "}
            <a
              href="https://wiki-weather.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://wiki-weather.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: info@wikiweather.com</p>
        </li>
        <li>
          <p>
